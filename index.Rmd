...
marriage_data <- fread("data_2/table_4/marriage_data.csv") 
#|>
   # mutate(cat=fifelse(Value<16.1, "<16.1", fifelse(Value>16.0 & Value<20.1, "16.1-20.0", fifelse(Value>20.0 & Value <40.1, "20.1-40.0",">40.0"))))

#write.csv(marriage_data, "data_2/table_4/marriage_data.csv", row.names = FALSE)
...
median_age <- fread("data_2/table_5/Table 5.11 Median age at first birth.csv")
# |>
...
fertility_preferences <- fread("data_2/table_7/table7_fertilitypreferences.csv")
# |>
#   filter(Desire_children%in%c("Have another soon","Have another later","Want no more")) |>
#   mutate(Percent=fifelse(Percent>0.5, round(Percent), Percent))
...
```{r, include=F}
# import data
need_demand <- fread("data_2/table_7/Table_7.15.1_2_Need and Demand for family planning.csv") 
# |>
...
itn_source <- fread("data_2/table_12/table12_2_ITN_source_by_background_xtics.csv")
# |>
...
itn_source_county <- fread("data_2/DHS County tables/table12_2C_ITN_grp_source_by_county.csv")
# |>
#   filter(Category%in%c("Mass distribution campaign","Shop/market","ANC visit","Immunization visit"))
...
itn_access <- fread("data_2/table_12/table12_3_ITN_access_by_background_xtics.csv") 
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
itn_use <- fread("data_2/table_12/table12_4_ITN_use_by_background_xtics.csv") 
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
existing_itn_use <- fread("data_2/table_12/table12_5_existing_ITN_use_by_background_xtics.csv") 
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
```{r, include=F}
# import data
children_itn_use <- fread("data_2/table_12/table12_6_children_ITN_use_by_background_xtics.csv")
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))

#write.csv(agricultural_land_ownsership_county,"data_2/table_15/Table_15.5.1C&15.5.3CAgricultural _and_ownership_county.csv",row.names = FALSE)
...
```{r, include=F}
# import data
women_itn_use <- fread("data_2/table_12/table12_7_women_ITN_use_by_background_xtics.csv")
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
reason_itn_not_used <- fread("data_2/table_12/table12_8_reason_itn_not_used_by_background_xtics_2.csv")
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
```{r, include=F}
# import data
iptp <- fread("data_2/table_12/table12_9_iptp_by_background_xtics.csv")
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
```{r, include=F}
# import data
mal_fever <- fread("data_2/table_12/table12_10_malaria_fever_by_background_xtics.csv") 
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
```{r, include=F}
# import data
mal_treat_source <- fread("data_2/table_12/table12_11_malaria_treat_by_source.csv") 
# |>
#    mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
hiv_meds_kap <- fread("data_2/table_13/table13_1_HIV_meds_KAP_by_background_xtics.csv") 
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
hivc <- fread("data_2/table_23/table23_hiv_count_data.csv") 
# |>
...
hivc1$Participants <- fct_relevel(hivc1$Participants, "Women (15-24 years)", "Men (15-24 years)")
...
hiv_testc <- fread("data_2/DHS County tables/table13_7C_grp_HIV_testing_by_county.csv")
# |>
...
bp <- fread("data_2/table_14/table14_1_BP_by_background_xtics.csv") 
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
depression <- fread("data_2/table_14/table14_5_Depression_by_background_xtics.csv")
# |>
...
```{r, include=F}
depression_county <- fread("data_2/DHS County tables/table14_5C_grp_Depression_by_county.csv")
# |>
#   mutate(Category=recode(Category,"Diagnosed with Depression"="Diagnosed with Depression and/or Anxiety"))
...
arthritis <- fread("data_2/table_14/table14_6_Arthritis_by_background_xtics.csv") 
# |>
#   mutate(Proportion=fifelse(Proportion>0.5, round(Proportion), Proportion))
...
physical_activity <- fread("data_2/table_14/table14_7_Physical_activity_by_background_xtics.csv")
# |>
...
breast_cancer <- fread("data_2/table_14/table9_19a_Breast_cancer_by_background_xtics.csv")
# |>
#   mutate(Proportion=fifelse(Proportion>0.5,round(Proportion), Proportion))
...
```{r, include=F}
cervical_cancer_county <- fread("data_2/DHS County tables/table9_19Cb_grp_Cervical_cancer_by_county.csv")
# |>
#   mutate(County=recode(County,"Elgeyo-Marakwet"="Elgeyo Marakwet", "Murang'a"="Muranga", "Tharaka-Nithi"="Tharaka Nithi"))
...
T15.1 <- fread("data_2/table_15/table_15_1_employment_and_cash_earnings_of_currently_married_women_and_men.csv")
# |>
...
T15.2.2 <- fread("data_2/table_15/table_15_2_2_control_over_mens_cash_earnings.csv", na.strings=c("*"))|> 
...
Agricultural_land_ownsership <- fread('data_2/table_15/table_15.5.1_&_table_15.5.3_Agicultural_Land_ownership.csv')
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))


agricultural_land_ownsership_county <- fread('data_2/table_15/Table_15.5.1C&15.5.3CAgricultural _and_ownership_county.csv') 
#|>
...
non_agricultural_land_ownsership <- fread('data_2/table_15/table_15.5.2_&_table_15.5.4_Longformat.csv') 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value)) 


non_agricultural_land_ownsership_county <- fread('data_2/table_15/Table_15.52C&15.5.3C_ Non_agricultural_land_ownership _county.csv') 
# |>
#   mutate(variable=recode(variable, "Does not have a title deed"="Does not have \na title deed")) |>
...
T15.6.1 <- fread("data_2/table_15/Table_15_6_1_ownership_and_use_of_mobile_phones_and_bank_accounts.csv") 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
decision_making <- fread("data_2/table_15/Table_15_8_2_participation_in_decision_making.csv") 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
decision_making_county <- fread("data_2/table_15/Table_15_8_2C_participation_in_decision_making_map.csv") 
...
T15.10 <- fread("data_2/table_15/Table_15_10_attitudes_toward_negotiating_safer_sexual_relations_with_husband.csv") 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value)) |>
...
T15.10C <- fread("data_2/table_15/Table_15_10C_attitudes_toward_negotiating_safer_sexual_relations_with_husband_map.csv") 
# |>
#   mutate(value=abs(value)) |>
...
```{r, include=F}
#import data
physical_violence <- fread('data_2/table_17/table_17.1_Experience_pysical_violence.csv') 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
pers_physical_violence <- fread('data_2/table_17/table_17.2_person_commiting_physical_violence.csv') 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
```{r, include=F}
#import data
violence_preg <- fread('data_2/table_17/table 17.3 Experience of violence during pregnancy_longformat.csv')
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
```{r, include=F}
#import data
sexual_violence <- fread('data_2/table_17/table_17.4_experience_sexual_violence.csv') 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
```{r, include=F}
#import data
sexual_violence1 <- fread('data_2/table_17/table_17.2_person_commiting_physical_violence.csv') 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
```{r, include=F}
#import data
controlling <- fread('data_2/table_17/Table_17_9_2_forms_of_controlling_behaviors_and_intimate-partner_violence.csv') 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
```{r, include=F}
#import data
violence_spouse <- fread('data_2/table_17/Table_17_13_violence_by_any_spouse_or_intimate_partner_in_the_last_12_months.csv')
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
```{r, include=F}
#import data
violence_women <- fread("data_2/table_17/table_17_16_Violence_by_respondent_against_their_spouse.csv") 
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
```{r, include=F}
#import data
T17.17 <- fread("data_2/table_17/table_17_17_Help_seeking_to_stop_violence.csv")  
# |>
#   mutate(value=fifelse(value>0.5, round(value), value))
...
comparison_data1a <- fread("data_2/County Comparison Data/comparison_data_wide1a.csv") 
# |>
